...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>{t("Pintados Feud")}</title>
        <link rel="icon" href="x.png"></link>
        <meta name="author" content="John Carl Acosta" />
        <meta
          name="description"
          content="Free to play open source family feud game. Host your own custom created family feud games with built in online buzzers, timers and admin controls. Visit https://github.com/JohnCarl2234/Pintados-Feud to check out the source code and contribute."
        />
        <link
          rel="preload"
